...
## Pilotlauf 6: Klimakipppunkt-Frage als neues Testobjekt

> **Hinweis:** Das vollstaendige Versuchsdesign fuer Pilotlauf 6 ist als
> eigener Trylayer-Plan ausgelagert, weil es ein eigenstaendiges
> Testobjekt mit eigenem Design ist:
> [`pilotlauf-6-klimakipppunkt-eisschild.md`](pilotlauf-6-klimakipppunkt-eisschild.md).
> Dieser Abschnitt bleibt als kurze Zusammenfassung mit Verweis stehen.
